...
Generate a complete golden test file that follows Constitution Appendix B (Safe Mode Protocol) for visual regression testing across all 8 theme variants (5 themes × 2 brightness modes).
