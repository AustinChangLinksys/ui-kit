...
class _DashboardHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        AppText('Good morning!', variant: AppTextVariant.headlineSmall),
        Row(
          children: [
            const Icon(Icons.calendar_today, size: 16, color: Colors.grey),
            AppGap.xs(),
            AppText.bodyMedium('9:17 AM Dec 1, 2025', color: Colors.grey),
          ],
        ),
      ],
    );
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        AppText.bodyMedium('1.0.10.216621 '),
                        const Icon(Icons.check, color: Colors.green, size: 16),
                        AppText.labelSmall(' Up to date', color: Colors.green),
                      ],
                    ),
                  ],
                ),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          SizedBox(
            width: 100,
            child: AppText.bodyMedium(label, color: Colors.grey),
          ),
        ...
        children: [
          ...
          Center(
            child: Column(
              children: [
                ...
                AppGap.xs(),
                AppText.headlineSmall('1Gbps'),
                AppText.labelSmall('Connected Speed'),
              ],
            ),
          ),
          const AppDivider(),
          ...
          Row(
            children: [
              ...
              AppGap.xs(),
              AppText.labelSmall('Understand your speed test results'),
            ],
          ),
          AppGap.md(),
          Row(
          ...
          Center(
            child: AppText.bodyMedium(
              'Or test with your preferred service',
              color: Colors.grey,
            ),
          ),
        ],
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Row(
                children: [
                  AppText.labelSmall('Firmware is '),
                  AppText.bodyMedium('up-to-date', color: Colors.green),
      ...
      child: Row(
        ...
        children: [
          ...
          SizedBox(
            width: 24,
            child: hasLine
                ? CustomPaint(painter: _TreeLinePainter(isLast: isLast))
                : null,
          ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          AppText.labelSmall(subtitle, color: Colors.grey),
                        ],
                      ),
                    ),
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              AppText.bodyMedium(widget.band, color: Colors.grey),
              AppSwitch(
                value: _isOn,
          ...
          AppGap.sm(),
          AppText(widget.ssid, variant: AppTextVariant.titleMedium),
          AppGap.lg(),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              ...
              const Icon(
                Icons.qr_code,
                size: 20,
              ), // removed hardcoded white to adapt to theme
            ],
          ),
        ],
      ),
